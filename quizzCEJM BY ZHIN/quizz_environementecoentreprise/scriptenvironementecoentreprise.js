...
let question1 = new Question("Qu’est-ce qu’un agent économique ? ", ["Un agent du gouvernement", "Une personne normale" ], [2]);
quiz.addQuestion(question1);

let question2 = new Question("Est-ce qu'une organisation peut être concidérée comme un agent économique ?", ["Oui", "Non"], [1]);
quiz.addQuestion(question2);

let question3 = new Question("il existe 5 catégories d'agents, lesquelles  ? ", ["Les ménages", "Les entreprises", "Les écoles", "Les club de sport", "L'État", "les asso", "Le reste du monde", "Les mairies", "Les institutions financières" ], [1,2,5,7,9]);
quiz.addQuestion(question3);

let question4 = new Question("qu'elle sont les opération des agents économiques ?   ", ["Les opérations d'héritage", "Les opérations sur biens et services", "Les opérations de répartition", "Les opérations financières","Les opérations de l'État"], [2,3,4]);
quiz.addQuestion(question4);

let question5 = new Question("qu'est ce qu'est l'environnement macro et micro économique d'une entreprise ? ", ["Elle est constituée de tous les éléments intérieurs à l'entreprise et qui ont une influence direct et indirect, passive ou négative sur elle. ", "Elle est constituée de tous les éléments extérieur à l'entreprise et qui ont une influence direct et négative sur elle.", "Elle est constituée de tous les éléments extérieur à l'entreprise et qui ont une influence direct et indirect, passive ou négative sur elle."], [3]);
quiz.addQuestion(question5);

let question6 = new Question("De quoi est constitué le micro environnement ? ", ["C'est l'environnement générale au sein duquel l'entreprise évolue.", "Il est constitué par les principaux agents économiques en relation avec l'entreprise."], [2]);
quiz.addQuestion(question6);

let question7 = new Question("De quoi est constitué le macro environnement ? ", ["C'est l'environnement générale au sein duquel l'entreprise évolue.", "Il est constitué par les principaux agents économiques en relation avec l'entreprise."], [1]);
