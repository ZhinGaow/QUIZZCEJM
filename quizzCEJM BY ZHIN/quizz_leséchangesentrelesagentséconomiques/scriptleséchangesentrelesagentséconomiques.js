...
let question1 = new Question("Qu’est-ce que l'échange économique ? ", [" C'est un acte de cession avec contre partie entre deux agents économiques  ", "C'est un acte de disposition entre deux agents économiques." ], [1]);
quiz.addQuestion(question1);

let question2 = new Question(" Quelles sont les trois formes de monnaie lors d'un échange économique ?", ["Monnaie fiduciaire, scripturale, intélectuelle", "Monnaie électronique, scripturale, liquide","Monnaie électronique, fudiciaire, scripturale"], [3]);
quiz.addQuestion(question2);

let question3 = new Question("Que signifie la masse monétaire ? ", ["C'est la quantité de monnaie en circulation dans le monde.", "C'est la quantité de monnaie en circulation dans un endroit déterminé."], [2]);
quiz.addQuestion(question3);

let question4 = new Question("Existe-il autant de marché qu'il y a de biens économiques ?   ", ["Non", "Oui"], [2]);
quiz.addQuestion(question4);

let question5 = new Question(" Comment le marché peut être en surproduction ? ", ["La demande est supérieure à l'offre."," L'offre est supérieure à la demande."], [2]);
quiz.addQuestion(question5);

let question6 = new Question("Comment le marché peut être en pénurie ? ", ["La demande est égale à l'offre.", "L'offre est supérieure à la demande.","La demande est supérieure à l'offre."], [2]);
