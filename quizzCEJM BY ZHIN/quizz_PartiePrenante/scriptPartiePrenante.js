...
let question1 = new Question("Est ce que les parties prenantes affectent directement ou indirectement les décisions prises dans une entreprise ? ", ["Non", "Oui" ], [2]);
quiz.addQuestion(question1);

let question2 = new Question("Est-ce que les fournisseurs qui réapprovisionnent sont considérés comme des parties prenantes ?", ["Oui", "Non"], [1]);
quiz.addQuestion(question2);

let question3 = new Question("Est-ce qu'un client est une partie prenante  ? ", ["Non", "Oui"], [2]);
quiz.addQuestion(question3);

let question4 = new Question("Une personne qui n'est pas intéressée et qui n'a aucun lien avec l'entreprise est-elle une partie prenante ?   ", ["Non", "Oui"], [1]);
quiz.addQuestion(question4);

let question5 = new Question("Qu'est ce qu'un contre pouvoir ? ", ["Une ou des personnes agissant pour limiter le pouvoir ", "Une ou des personne agissant pour aider l'entreprise", "Une entreprise qui souhaite attaquer le pouvoir d'une autre"], [1]);
quiz.addQuestion(question5);

let question6 = new Question("Quels sont les moyens d'action des contrepouvoirs pour les salariés ? ", ["La grève", "attaque en justice", "Faire des casses dans l'entreprise", "Ne plus faire son travail"], [2,1]);
quiz.addQuestion(question6);

let question7 = new Question("Quels sont les moyens d'action des contrepouvoirs pour les consommateurs ? ", ["Mener un raid pour voler le magasin", "Boycotter les produits", "Harceler l'entreprise", "Mener des actions en justice"], [2,4]);
quiz.addQuestion(question7);

let question8 = new Question("Quels sont les moyens d'action des contrepouvoirs pour les actionnaires ? ", ["Ventes de leurs actions ", "Faire des cyberattaques"], [1]);
quiz.addQuestion(question8);

let question9 = new Question("Quels sont les moyens d'action des contrepouvoirs pour les asso et ONG ? ", ["Mener l'entreprise en justice", "Les médias", "La révélation d'enquête"], [1,2,3]);
quiz.addQuestion(question9);

let question10 = new Question("Quels sont les moyens d'action des contrepouvoirs pour l'État? ", ["Les forces publiques", "En mettant tous les salariés en prison", "En sanctionnant", "En modifiant la réglementation", "En arretant la famille du responsable"], [1,3,4]);
quiz.addQuestion(question10);

let question11 = new Question("Quels sont les moyens d'action des contrepouvoirs pour les fournisseurs ? ", ["En se retirant", "En insultant", "En augmentant ses prix", "En fournissant de mauvaises marchandises"], [1,3]);
